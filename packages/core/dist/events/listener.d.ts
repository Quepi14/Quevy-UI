 ...
 */
import type { EventListener, EventListenerOptions } from './types.js';
/**
 ...
 */
export declare function listen<T extends Event = Event>(target: EventTarget, type: string, listener: EventListener<T>, options?: EventListenerOptions): () => void;
