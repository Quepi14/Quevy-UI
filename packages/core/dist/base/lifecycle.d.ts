 ...
 */
export interface QvLifecycle extends Partial<OnConnected>, Partial<OnDisconnected>, Partial<OnFirstRender>, Partial<BeforeRender>, Partial<AfterRender>, Partial<LitElementLifecycle> {
}
