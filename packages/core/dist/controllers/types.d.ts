 ...
 */
export type ControllerConstructor<TController extends QvController<THost>, THost extends QvElement = QvElement> = new (host: THost) => TController;
/**
 ...
 * @template THost - Host component type.
 */
export type ControllerInstance<THost extends QvElement = QvElement> = QvController<THost>;
/**
 ...
 * @template THost - Host component type.
 */
export type ControllerCollection<THost extends QvElement = QvElement> = Set<ControllerInstance<THost>>;
