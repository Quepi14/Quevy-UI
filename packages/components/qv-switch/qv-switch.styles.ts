...
.track {
    ...
    transition: background-color var(--qv-motion-duration-moderate, 240ms) var(--qv-motion-easing-standard, cubic-bezier(0.2, 0, 0, 1));
}
...
.thumb {
    ...
    transition: transform var(--qv-motion-duration-moderate, 240ms) var(--qv-motion-easing-spring, cubic-bezier(0.34, 1.56, 0.64, 1));
}
