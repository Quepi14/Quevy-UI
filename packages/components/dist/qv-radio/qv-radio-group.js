...
let QvRadioGroup = class QvRadioGroup extends QvRadioGroupBase {
    constructor() {
        super(...arguments);
    ...
    static { this.styles = qvRadioGroupStyles; }
    get currentValue() {
        return this.controllableValue.value(this.value);
    }
    onConnected() {
        this.setAttribute('role', 'radiogroup');
        this.addEventListener('qv-radio-activate', this.handleActivate);
        this.addEventListener('keydown', this.handleArrowNav);
    }
    onDisconnected() {
        this.removeEventListener('qv-radio-activate', this.handleActivate);
        this.removeEventListener('keydown', this.handleArrowNav);
    }
    get radios() {
        return Array.from(this.querySelectorAll('qv-radio'));
    }
...
__decorate([
    property()
], QvRadioGroup.prototype, "value", void 0);
__decorate([
    property()
