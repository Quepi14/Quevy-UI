...
${host()}{
    ...
    border-radius: var(--qv-radius-md, 4px);
...
`);
export const qvButtonStyles = createStyles(css(layout, sizes, variant, states, spinner));
//# sourceMappingURL=qv-button.styles.js.map